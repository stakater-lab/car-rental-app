package io.aurora.provider.config;
...
@Configuration
@EnableMongoRepositories("io.aurora.provider.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("io.aurora.provider.config.dbmigrations");
