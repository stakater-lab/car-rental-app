...
public class RatingResourceIntTest {
    ...
    private static final Double DEFAULT_COMMULATIVE = 1D;
    private static final Double UPDATED_COMMULATIVE = 2D;
    ...
    public void createRating() throws Exception {
        ...
        assertThat(testRating.getCommulative()).isEqualTo(DEFAULT_COMMULATIVE);
    }
    ...
    public void getAllRatings() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].commulative").value(hasItem(DEFAULT_COMMULATIVE.doubleValue())));
    }
    ...
    public void getRating() throws Exception {
        ...
        restRatingMockMvc.perform(get("/api/ratings/{id}", rating.getId()))
            ...
            .andExpect(jsonPath("$.commulative").value(DEFAULT_COMMULATIVE.doubleValue()));
    }
    ...
    public void updateRating() throws Exception {
        ...
        Rating testRating = ratingList.get(ratingList.size() - 1);
        assertThat(testRating.getCommulative()).isEqualTo(UPDATED_COMMULATIVE);
    }
