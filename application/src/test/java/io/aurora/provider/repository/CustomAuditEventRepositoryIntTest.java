...
import io.aurora.provider.config.audit.AuditEventConverter;
import io.aurora.provider.domain.PersistentAuditEvent;
...
import static io.aurora.provider.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
